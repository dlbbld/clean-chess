...
public class PgnExpectedValue {
  ...
  private static PgnFileTestCaseList createTestCasesBasicCheckmateWhite() {
    ...
    list.add(new PgnFileTestCase("03_white_rook_checkmate_discover.pgn", "", "", "", -1, 3,
    ...
    list.add(new PgnFileTestCase("04_white_knight_checkmate_direct.pgn", "", "", "", -1, 1,
        CheckmateOrStalemate.CHECKMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("09_white_bishop_checkmate_discover.pgn", "", "", "", -1, 1,
        CheckmateOrStalemate.CHECKMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesBasicCheckmateBlack() {
    ...
    list.add(new PgnFileTestCase("03_black_rook_checkmate_discover.pgn", "", "", "", -1, 5,
        CheckmateOrStalemate.CHECKMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.WINNABLE, "3K4/1r6/3k4/b3r3/5N2/8/8/2r5 w - - 5 103"));
    list.add(new PgnFileTestCase("04_black_knight_checkmate_direct.pgn", "", "", "", -1, 1,
        CheckmateOrStalemate.CHECKMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("09_black_bishop_checkmate_discover.pgn", "", "", "", -1, 5,
        CheckmateOrStalemate.CHECKMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesBasicCheckmateVariousWhite() {
    final List<PgnFileTestCase> list = new ArrayList<>();
    list.add(new PgnFileTestCase("01_checkmate_by_white_capture_yes.pgn", "", "", "", 7, 5,
        CheckmateOrStalemate.CHECKMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.WINNABLE, "1r1qkbnr/pbp2Qp1/2pp3p/4p1N1/4P3/8/PPPP1PPP/RNB1K2R b KQk - 0 8"));
    list.add(new PgnFileTestCase("02_checkmate_by_white_capture_no.pgn", "", "", "", -1, 5,
        CheckmateOrStalemate.CHECKMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("04_checkmate_fools_mate_by_white.pgn", "", "", "", -1, 1,
        CheckmateOrStalemate.CHECKMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesBasicThreefold() {
    ...
    list.add(new PgnFileTestCase("threefold_01_2_moves_very_low_end_with_threefold.pgn", "repPos=3: 2...Ng8 4...Ng8",
        "", "", -1, 8, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_02_2_moves_low_end_with_threefold.pgn", "repPos=3: 3...Nc6 5...Bf8 7...Bf8",
        "", "", -1, 10, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_03_2_moves_medium_end_with_threefold.pgn", "repPos=3: 9.O-O 11.Rf1 13.Rf1",
        "", "", -1, 15, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_08_2_en_passant_capture_castling_end_with_threefold.pgn",
        ...
        3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_10_1_multiple_threefolds_end_with_last.pgn", threefoldRepetitionMultiple,
        "", "", -1, 12, CheckmateOrStalemate.NA, 4, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
        UnwinnableFullResultTest.WINNABLE, "rnbqkbnr/ppp2pp1/8/3pp2p/3PP2P/6P1/PPP2P2/RNBQKBNR b KQkq - 12 16"));
    list.add(
        new PgnFileTestCase("threefold_10_2_multiple_threefolds_continue_beyond_last.pgn", threefoldRepetitionMultiple,
            "", "", 37, 13, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_11_3_max_position_repetitions_for_threefold_both_up_to_fivefold.pgn",
        ...
        CheckmateOrStalemate.NA, 5, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_max_visual_position_repetition_before_threefold_not_varying_busted.pgn",
        ...
        -1, 90, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_castling_white_both_sides_lost.pgn", "repPos=3: 5...Ke8 7...Nb8 9...Nb8",
        "", "", -1, 16, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_two_square_advance_pawn_same_rank_no_1_one_before_threefold.pgn", "", "",
        "", -1, 7, CheckmateOrStalemate.NA, 2, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_en_passant_capture_exposing_own_king_to_check_chess.com.pgn",
        ...
        UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.WINNABLE, "6k1/8/8/8/5Pp1/8/6R1/6K1 b - - 12 38"));
  ...
  private static PgnFileTestCaseList createTestCasesBasicThreefoldInitialEnPassantCapture() {
    ...
    list.add(
        new PgnFileTestCase("initial_ep_three_repetitions_end_with_yes.pgn", "", "repPos=3: 2...d5 4...Bc8 8...Nb8", "",
            -1, 12, CheckmateOrStalemate.NA, 2, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("initial_ep_three_repetitions_end_with_no.pgn", "", "repPos=3: 2...d5 4...Bc8 8...Nb8",
        "", -1, 14, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesBasicFifty() {
    ...
    list.add(new PgnFileTestCase("fifty_04_1_last_move_white_is_stalemated.pgn", "", "", "24.Ke3 (1) 73...Qc2 (100)", 5,
        100, CheckmateOrStalemate.STALEMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesBasicFivefold() {
    ...
    list.add(new PgnFileTestCase("fivefold_02_1_one_before_fivefold.pgn",
        ...
        "", "", -1, 15, CheckmateOrStalemate.NA, 4, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
        UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("fivefold_03_2_continue_previous_and_end_with_sixfold.pgn",
        ...
        "", "", -1, 20, CheckmateOrStalemate.NA, 6, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesBasicSeventyFive() {
    ...
    list.add(new PgnFileTestCase(
        ...
        167, 178, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase(
        ...
        "",
        "7.Ba6 (1) 56...Nd6 (100) 81...Kc8 (150) 83...Ka7 (154); 84...Rf8 (1) 134.Qd5 (100) 159.Qh6 (150) 173.Re7 (178)",
        167, 178, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesBasicIntervening() {
    ...
    list.add(new PgnFileTestCase("intervening_fivefold_encapsulating_fivefold.pgn",
        ...
        "", -1, 34, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("intervening_fivefold_interlocked_fivefold.pgn",
        ...
        "", -1, 40, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesBasicFromFen() {
    ...
    list.add(
        new PgnFileTestCase("repetition_from_one_move_white_to_move_threefold.pgn", "repPos=3: 17.Qa4 19.Qa4 21.Qa4",
            "", "", -1, 9, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(
        new PgnFileTestCase("repetition_from_three_moves_white_to_move_threefold.pgn", "repPos=3: 14.f4 16.Qc3 18.Nd2",
            "", "", -1, 8, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(
        new PgnFileTestCase("repetition_from_two_moves_black_to_move_threefold.pgn", "repPos=3: 13.a4 15.Qd1 17.Nc3",
            "", "", -1, 8, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(
        new PgnFileTestCase("repetition_from_zero_moves_white_to_move_threefold.pgn", "repPos=3: 51...Nf6 53...Nf6", "",
            "", -1, 18, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesBasicFromFenYawnBlack() {
    ...
    list.add(new PgnFileTestCase("16_black_initial_above_seventy_five_reoccuring_above_seventy_five.pgn", "", "",
        ...
        1, 163, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.UNWINNABLE, "1Q6/6pk/8/6n1/2N5/6q1/1KP1P3/8 w - - 158 180"));
  ...
  private static PgnFileTestCaseList createTestCasesLong() {
    ...
    list.add(new PgnFileTestCase("nikolic_arsovic_1989.pgn",
        ...
        33, 205, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesLongestMate() {
    ...
    list.add(new PgnFileTestCase("longest_mate_seven_pieces_rank_1_amend_reproduce_and_repeat_position.pgn", "", "", "",
        3, 33, CheckmateOrStalemate.NA, 2, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesRandomNoRepetition() {
    ...
    list.add(
        new PgnFileTestCase("no_repetition_2.pgn", "", "", "180...Ke8 (1) 230.Ka8 (100) 255.Kg6 (150) 880.Kh1 (1400)",
            10, 1400, CheckmateOrStalemate.NA, 1, InsufficientMaterial.WHITE_ONLY, UnwinnableFullResultTest.UNWINNABLE,
            UnwinnableFullResultTest.UNWINNABLE, "8/8/8/8/1k6/8/4r3/7K b - - 1400 880"));
    ...
    list.add(new PgnFileTestCase("no_repetition_4.pgn", "", "",
        ...
        27, 156, CheckmateOrStalemate.NA, 1, InsufficientMaterial.BLACK_ONLY, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesRandomSeventyFive() {
    ...
    list.add(new PgnFileTestCase("random_seventy_five_1.pgn", "", "", "176.Bf7 (1) 225...Kd6 (100) 250...Kd6 (150)", 8,
        150, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("random_seventy_five_2.pgn", "", "", "198.Re8 (1) 247...Kg2 (100) 272...Ka1 (150)", 15,
        150, CheckmateOrStalemate.NA, 1, InsufficientMaterial.BLACK_ONLY, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("random_seventy_five_3.pgn", "", "", "162.Kb2 (1) 211...Ke4 (100) 236...Kh6 (150)", 20,
        150, CheckmateOrStalemate.NA, 1, InsufficientMaterial.WHITE_ONLY, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.UNWINNABLE, "8/8/3q3k/8/8/8/8/2K5 w - - 150 237"));
    list.add(new PgnFileTestCase("random_seventy_five_4.pgn", "", "", "132.Kg8 (1) 181...Ng2 (100) 206...Kc2 (150)", 22,
        150, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesRandomThreefold() {
    ...
    list.add(new PgnFileTestCase("random_threefold_3.pgn", "repPos=3: 158.Ke3 162.Ke3 171.Ke3", "", "", 36, 40,
        CheckmateOrStalemate.NA, 3, InsufficientMaterial.BLACK_ONLY, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("random_threefold_5.pgn", "repPos=3: 198...Ke3 200...Ke3 202...Ke3", "", "", 11, 38,
        CheckmateOrStalemate.NA, 3, InsufficientMaterial.WHITE_ONLY, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.WINNABLE, "8/8/8/1K6/8/4k3/7p/8 w - - 26 203"));
  ...
  private static PgnFileTestCaseList createTestCasesRandomFivefold() {
    ...
    list.add(new PgnFileTestCase("random_fivefold_1.pgn",
        ...
        "", "", 22, 89, CheckmateOrStalemate.NA, 5, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesGamesVarious() {
    ...
    list.add(new PgnFileTestCase("anikonov_zhigalko_2018.pgn", "", "", "104.Ra8 (1) 153...Ke5 (100) 166...Kb5 (126)", 8,
        126, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("bazeev_riazantsev_2018.pgn", "", "", "59.Ke3 (1) 108...Ng6+ (100) 109...Nf8+ (102)",
        8, 102, CheckmateOrStalemate.NA, 1, InsufficientMaterial.WHITE_ONLY, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.WINNABLE, "5n2/5k1K/8/8/6n1/8/8/8 w - - 102 110"));
    ...
    list.add(new PgnFileTestCase("khademalsharieh_bodnaruk_2018.pgn", "repPos=3: 77...Re1 79...Kg7 83...Kg7", "", "",
        21, 49, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("gwendolus_vs_danielbaechli_2022.pgn", "repPos=3: 50.Bd4 52.Rh6 54.Rh6", "", "", 12,
        15, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesGamesWcc201() {
    ...
    list.add(new PgnFileTestCase("round_07_nepomniachtchi_carlsen_2021_wcc.pgn",
        ...
        "", "", 17, 15, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesFivefoldCorrect() {
    ...
    list.add(new PgnFileTestCase("akshat_li_2018.pgn", "repPos=5: 60...Rc1 62...Rc1 68...Rc1 73...Rc1 75...Rc1", "", "",
        19, 32, CheckmateOrStalemate.NA, 5, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("miton_yakubboev_2018.pgn",
        ...
        "", "", 25, 23, CheckmateOrStalemate.NA, 5, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("potapov_adly_2018.pgn", "repPos=5: 43.Qf5+ 45.Qf5+ 47.Qf5+ 49.Qf5+ 51.Qf5+", "", "",
        20, 24, CheckmateOrStalemate.NA, 5, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("sethuraman_guseinov_2017.pgn",
        ...
        "", "", 14, 19, CheckmateOrStalemate.NA, 5, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("paichadze_ter-sahakyan_2019.pgn",
        ...
        "", "", 5, 18, CheckmateOrStalemate.NA, 5, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("robson_moranda_2019.pgn",
        ...
        "", "", 6, 17, CheckmateOrStalemate.NA, 5, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesFivefoldBeyond() {
    ...
    list.add(new PgnFileTestCase("savchenko_yu_y2017.pgn",
        ...
        "", "", 20, 43, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("wang_yu_2017.pgn",
        ...
        "", "", 17, 36, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesFiftyGeneral() {
    ...
    list.add(new PgnFileTestCase("cheparinov_anand_2018.pgn", "", "", "61...Kb5 (1) 111.Ra7 (100) 130.Rb1 (138)", 11,
        138, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("riazantsev_levin_2016.pgn",
        ...
        UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.WINNABLE, "5Rqk/8/6PP/8/5P2/5NK1/8/8 b - - 4 181"));
    list.add(new PgnFileTestCase("radjabov_deac_2016.pgn", "", "", "69...Kf5 (1) 119.Rh2 (100) 126...Ke5 (115)", 17,
        115, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("vaisser_karpov_2017.pgn", "", "", "82...Kd7 (1) 132.Ke4 (100) 152.Bc3+ (140)", 11,
        140, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("wang_wen_2018.pgn",
        ...
        UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.WINNABLE, "8/8/8/8/4BK2/1r6/7k/2R5 b - - 148 169"));
    ...
    list.add(new PgnFileTestCase("bindrich_kovalev_2018.pgn", "", "", "57...Ra3+ (1) 107.Kg2 (100) 118.Kf3 (122)", 15,
        122, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("topalov_dominguez_2019.pgn", "", "", "38...Qc3 (1) 88.Kg3 (100) 90.Kg3 (104)", 22,
        104, CheckmateOrStalemate.CHECKMATE, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesFiftyPattern() {
    ...
    list.add(new PgnFileTestCase("98_start_white_demchenko_martinez_2019.pgn", "repPos=3: 70...Ng5 83...Kh5 103...Kh5",
        "", "", 29, 98, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("99_start_black_naroditsky_boruchovsky_2018.pgn",
        ...
        "", "", 27, 99, CheckmateOrStalemate.NA, 4, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("102_start_black_riazantsev_deac_2017.pgn", "", "",
        ...
        UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.WINNABLE, "8/8/8/3nk3/R7/5K2/8/8 b - - 102 142"));
  ...
  private static PgnFileTestCaseList createTestCasesSeventyFiveCorrect() {
    ...
    list.add(new PgnFileTestCase("topalov_nakamura_2016.pgn", "", "", "58.Kc8 (1) 107...Nc4 (100) 132...Rg8 (150)", 15,
        150, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.UNWINNABLE, "6r1/8/8/8/5k2/R6K/3n4/8 w - - 150 133"));
    list.add(new PgnFileTestCase("yudasin_erenburg_2017.pgn", "", "", "123.Kf2 (1) 172...Ke1 (100) 197...Ne7 (150)", 5,
        150, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesEarlyDraw() {
    ...
    list.add(new PgnFileTestCase("vachier-lagrave_ding_liren_2019.pgn", "repPos=3: 16...Qg6 18...Qg6 20...Qg6", "", "",
        19, 19, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesWikipediaThreefold() {
    ...
    list.add(
        new PgnFileTestCase("2_0_1_spassky_fischer_1972_seventeenth_changed.pgn", "repPos=3: 41...g5 43...Re1 45...Re1",
            "", "", 11, 20, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("2_0_2_fischer_spassky_1972_eighteenth_changed.pgn", "repPos=3: 44.Qh6 46.Qh6 48.Qh6",
        "", "", 8, 22, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(
        new PgnFileTestCase("2_2_1_ponomariov_adams_2005_wijk_aan_zee_changed.pgn", "repPos=3: 38.Kd2 40.Kd2 42.Kd2",
            "", "", 5, 9, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(
        new PgnFileTestCase("2_2_2_adams_ponomariov_2005_sofia_changed.pgn", "repPos=3: 23...Rc7 25...Kf6 27...Kf6", "",
            "", 5, 11, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("2_2_3_ponomariov_adams_2005_sofia.pgn", "", "", "", 17, 12, CheckmateOrStalemate.NA,
        2, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.WINNABLE,
        "3Q4/5pk1/7R/1p3Pp1/1P6/7P/6P1/4q2K w - - 7 53"));
    list.add(
        new PgnFileTestCase("2_2_3_ponomariov_adams_2005_sofia_changed.pgn", "repPos=3: 49...Qe5+ 51...Qe5+ 53...Qe5+",
            "", "", 17, 12, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
            UnwinnableFullResultTest.WINNABLE, "3Q4/5pk1/7R/1p2qPp1/1P6/7P/6PK/8 w - - 9 54"));
    ...
    list.add(new PgnFileTestCase("2_4_1_alekhine_lasker_1914_changed.pgn", "repPos=3: 17.Qxh6+ 19.Qh6+ 21.Qh6+", "", "",
        6, 8, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("2_5_korchnoi_portisch_1970_game_1.pgn", "repPos=3: 64.Kh5 66.Kh5 68.Rb8", "", "", 35,
        19, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("2_6_kasparov_deep_blue_1997_changed.pgn", "repPos=3: 50.g8=Q 52.Kb1 54.Kb1", "", "",
        8, 8, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("3_1_karpov_miles_1986_changed.pgn", "repPos=3: 22...Ra4 24...Ra4 26...Ra4", "", "", 7,
        10, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("3_2_fischer_spassky_1972_twentieth_changed.pgn", "repPos=3: 48.Kc3 50.Ne1 58.Kc3", "",
        "", 6, 37, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("4_0_1_pest_paris.pgn",
        ...
        "", "", 5, 23, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("4_0_1_pest_paris_six_fold.pgn",
        ...
        "", "", 5, 25, CheckmateOrStalemate.NA, 6, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesWikipediaFiftyMove() {
    ...
    list.add(new PgnFileTestCase("2_1_timman_lutz_1995.pgn", "", "", "69...Rh1 (1) 119.Rg5 (100) 121...Rb5+ (105)", 16,
        105, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("2_2_karpov_kasparov_1991.pgn", "", "", "63...Rg8 (1) 113.Ng5 (100) 114...Rf6+ (103)",
        30, 103, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(
        new PgnFileTestCase("2_3_lputian_harutjunyan_2001.pgn", "", "", "86...Qe2+ (1) 136.Qd4+ (100) 142.Qf6+ (112)",
            19, 112, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesSequence() {
    ...
    list.add(new PgnFileTestCase("rep_1.pgn",
        ...
        "", "", -1, 11, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesCapture() {
    ...
    list.add(new PgnFileTestCase("06_capture_last_move_en_passant_capture_more_moves_max_yawn_unchanged.pgn", "", "",
        "", 25, 4, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("08_capture_last_move_en_passant_capture_more_moves_max_yawn_changed.pgn", "", "", "",
        25, 9, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesSpecial() {
    ...
    list.add(new PgnFileTestCase("both_kings_blocked_in_a_corner_with_pawns_and_bishop_pawn_moves_exhausted.pgn", "",
        "", "", 24, 19, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(new PgnFileTestCase("white_king_trapped_on_side_with_pawns_capturing_only_piece_stalemates.pgn", "", "",
        "", 11, 8, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
        UnwinnableFullResultTest.UNWINNABLE_QUICK_DOES_NOT_SEE, UnwinnableFullResultTest.UNWINNABLE_QUICK_DOES_NOT_SEE,
    ...
    list.add(new PgnFileTestCase("unwinnable_fivefold_inevitable.pgn",
        ...
        "", "", 1, 15, CheckmateOrStalemate.NA, 4, InsufficientMaterial.BLACK_ONLY, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesDgtLiveChess() {
    ...
    list.add(new PgnFileTestCase("01_threefold_fails_castle_right.pgn", "repPos=3: 3...Nb8 5...Nb8 7...Ng8", "", "", -1,
        12, CheckmateOrStalemate.NA, 3, InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesDgtCentaur() {
    ...
    list.add(new PgnFileTestCase("fifty_move_rule_reached_by_human_move.pgn", "", "", "42...Kf4 (1) 92.Kd3 (100)", 5,
        100, CheckmateOrStalemate.NA, 1, InsufficientMaterial.BLACK_ONLY, UnwinnableFullResultTest.UNWINNABLE,
        UnwinnableFullResultTest.WINNABLE, "8/8/3k4/8/2B5/3K4/5B2/8 b - - 100 92"));
    list.add(new PgnFileTestCase("fifty_move_rule_reached_by_computer_move.pgn", "", "", "66.Ke4 (1) 115...Kh6 (100)",
        5, 100, CheckmateOrStalemate.NA, 1, InsufficientMaterial.BLACK_ONLY, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("threefold_repetition_reached_by_human_move.pgn", "repPos=3: 42.Kxe3 44.Ke3 46.Ke3",
        "", "", 6, 18, CheckmateOrStalemate.NA, 3, InsufficientMaterial.BLACK_ONLY, UnwinnableFullResultTest.UNWINNABLE,
  ...
  private static PgnFileTestCaseList createTestCasesUnfairLichessAnalysisGames() {
    ...
    list.add(
        new PgnFileTestCase("0dKUIfwq.pgn", "", "", "", 6, 7, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "7K/6qP/8/8/8/4k3/8/8 w - - 1 76"));
    ...
    list.add(
        new PgnFileTestCase("2sFHWmg3.pgn", "", "", "", 3, 11, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "7b/5k1K/7P/8/8/8/8/8 w - - 0 57"));
    list.add(
        new PgnFileTestCase("2wVTK5vV.pgn", "", "", "", 11, 14, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "5qK1/7P/8/k7/8/8/8/8 w - - 3 62"));
    ...
    list.add(
        new PgnFileTestCase("78XhRaIr.pgn", "", "", "", 32, 8, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/6qK/7P/8/8/2k5/8/8 w - - 0 73"));
    ...
    list.add(new PgnFileTestCase("B8bpMZ71.pgn", "", "", "", 11, 13, CheckmateOrStalemate.NA, 1,
        InsufficientMaterial.NONE, UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(
        new PgnFileTestCase("E9P918aj.pgn", "", "", "", 18, 7, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/8/8/8/3k2qK/7P/8/8 w - - 0 51"));
    ...
    list.add(
        new PgnFileTestCase("eKwKl6Y9.pgn", "", "", "", 17, 9, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/8/8/7P/8/6qK/8/2k5 w - - 0 70"));
    ...
    list.add(new PgnFileTestCase("FBqHYgEu.pgn", "repPos=3: 40.Ke2 68.Ke2 70.Ke2; repPos=3: 40...Kd6 68...Kd6 70...Kd6",
        "", "", 23, 88, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
    ...
    list.add(
        new PgnFileTestCase("GCuwJ5bP.pgn", "", "", "", 6, 8, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/8/8/Kq6/P5k1/8/8/8 w - - 0 52"));
    ...
    list.add(
        new PgnFileTestCase("hkiG96je.pgn", "", "", "", 10, 8, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "6qK/8/7P/8/8/k7/8/8 w - - 0 59"));
    ...
    list.add(
        new PgnFileTestCase("jehHS0Jj.pgn", "", "", "", 10, 11, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/6k1/8/6qK/8/7P/8/8 w - - 0 65"));
    ...
    list.add(
        new PgnFileTestCase("lHtqM0fz.pgn", "", "", "", 22, 19, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/8/8/8/6K1/8/7p/6Rk b - - 7 74"));
    ...
    list.add(
        new PgnFileTestCase("UdUE6AvZ.pgn", "", "", "", 16, 6, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/Kq6/P7/8/6k1/8/8/8 w - - 1 50"));
    ...
    list.add(
        new PgnFileTestCase("VdYuP1l4.pgn", "", "", "", 20, 8, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/8/8/p7/8/8/1Q5K/k7 b - - 0 62"));
    ...
    list.add(
        new PgnFileTestCase("vytUGbcM.pgn", "", "", "", 19, 7, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "7K/6Pq/8/3k4/8/8/8/8 w - - 0 74"));
    ...
    list.add(
        new PgnFileTestCase("xfvaW7PK.pgn", "", "", "", 12, 7, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "6qK/5k1P/8/8/8/8/8/8 w - - 1 51"));
    ...
    list.add(
        new PgnFileTestCase("xmpqlKFo.pgn", "", "", "", 9, 7, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/Kq6/8/8/8/8/P7/5k2 w - - 0 54"));
    ...
    list.add(
        new PgnFileTestCase("YRvWOIpy.pgn", "", "", "", 3, 10, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
            UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE, "8/R7/Kr6/P6k/8/8/8/8 w - - 1 57"));
  ...
  private static PgnFileTestCaseList createTestCasesUnfairNotQuick() {
    ...
    list.add(new PgnFileTestCase("f6c1lu7R.pgn", "", "", "", 13, 70, CheckmateOrStalemate.NA, 1,
  ...
  private static PgnFileTestCaseList createTestCasesUnfairAmbronaExamples() {
    ...
    list.add(new PgnFileTestCase("ae_07.pgn", "", "", "", -1, 10, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
        UnwinnableFullResultTest.UNWINNABLE_QUICK_DOES_NOT_SEE, UnwinnableFullResultTest.WINNABLE,
    ...
    list.add(new PgnFileTestCase("ae_16.pgn", "", "", "", -1, 10, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
        UnwinnableFullResultTest.UNWINNABLE, UnwinnableFullResultTest.UNWINNABLE_QUICK_DOES_NOT_SEE,
    ...
    list.add(new PgnFileTestCase("ae_17.pgn", "", "", "", -1, 10, CheckmateOrStalemate.NA, 1, InsufficientMaterial.NONE,
        UnwinnableFullResultTest.WINNABLE, UnwinnableFullResultTest.UNWINNABLE_QUICK_DOES_NOT_SEE,
  ...
  private static PgnFileTestCaseList createTestCasesPawnWall() {
    ...
    list.add(new PgnFileTestCase("norgaard_beyond_pawn_wall_example_1.pgn", "", "", "638...Kg8 (1) 688.Ka3 (100)", 5,
        100, CheckmateOrStalemate.NA, 2, InsufficientMaterial.NONE, UnwinnableFullResultTest.UNWINNABLE,
