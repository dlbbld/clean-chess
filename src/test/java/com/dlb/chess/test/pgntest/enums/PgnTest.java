...
public enum PgnTest {
  ...
  BASIC_CHECKMATE_WHITE(true, "basic/terminationPosition/checkmate/rbnqkVariations/white"),
  BASIC_CHECKMATE_BLACK(true, "basic/terminationPosition/checkmate/rbnqkVariations/black"),
  BASIC_CHECKMATE_VARIOUS_WHITE(false, "basic/terminationPosition/checkmate/various/white"),
  BASIC_CHECKMATE_VARIOUS_BLACK(false, "basic/terminationPosition/checkmate/various/black"),
  ...
  BASIC_STALEMATE(true, "basic/terminationPosition/stalemate"),
  ...
  BASIC_THREEFOLD(true, "basic/terminationClaim/threefold"),
  BASIC_THREEFOLD_INITIAL_EP(true, "basic/terminationClaim/threefoldInitialEnPassantCapture"),
  BASIC_FIFTY(true, "basic/terminationClaim/fifty"),
  BASIC_FIVEFOLD(true, "basic/terminationPosition/fivefold"),
  BASIC_SEVENTY_FIVE(true, "basic/terminationPosition/seventyFive"),
