...
class TestBasicPromotionPieceBlack extends AbstractTestBasic {
  ...
  static {
    ...
    pgnFileNameList.add("01_black_promotion_capture_no_rook.pgn");
    pgnFileNameList.add("02_black_promotion_capture_no_knight.pgn");
    pgnFileNameList.add("03_black_promotion_capture_no_bishop.pgn");
    pgnFileNameList.add("04_black_promotion_capture_no_queen.pgn");
    pgnFileNameList.add("05_black_promotion_capture_yes_rook.pgn");
    pgnFileNameList.add("06_black_promotion_capture_yes_knight.pgn");
    pgnFileNameList.add("07_black_promotion_capture_yes_bishop.pgn");
    pgnFileNameList.add("08_black_promotion_capture_yes_queen.pgn");
