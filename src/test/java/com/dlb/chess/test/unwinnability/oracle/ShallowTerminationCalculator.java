...
public class ShallowTerminationCalculator {
  ...
  private static boolean calculateIsEndMoveEvaluationMadeTheMove(GameStatus moveEvaluation) {
    return switch (moveEvaluation) {
      case CHECKMATE -> true;
      case FIVE_FOLD_REPETITION_RULE, DEAD_POSITION_INSUFFICIENT_MATERIAL, INSUFFICIENT_MATERIAL_WHITE_ONLY, INSUFFICIENT_MATERIAL_BLACK_ONLY, ONGOING, SEVENTY_FIVE_MOVE_RULE, STALEMATE -> false;
    };
  }
  ...
  private static boolean calculateIsEndMoveEvaluationNotMadeTheMove(GameStatus moveEvaluation, Side sideThatJustMoved) {
    return switch (moveEvaluation) {
      ...
      case CHECKMATE, FIVE_FOLD_REPETITION_RULE, DEAD_POSITION_INSUFFICIENT_MATERIAL, SEVENTY_FIVE_MOVE_RULE, STALEMATE -> false;
    };
  }
