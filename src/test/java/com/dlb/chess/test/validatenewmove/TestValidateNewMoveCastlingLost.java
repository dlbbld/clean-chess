...
class TestValidateNewMoveCastlingLost implements EnumConstants {
  ...
  void testWhiteKingMoved() {
    ...
    assertEquals(CastlingRight.NONE, board.getCastlingRightBoth().castlingRightWhite());
  ...
  void testBlackKingMoved() {
    ...
    assertEquals(CastlingRight.NONE, board.getCastlingRightBoth().castlingRightBlack());
  ...
  void testWhiteKingSideRookMoved() {
    ...
    assertEquals(CastlingRight.QUEEN_SIDE, board.getCastlingRightBoth().castlingRightWhite());
  ...
  void testBlackKingSideRookMoved() {
    ...
    assertEquals(CastlingRight.QUEEN_SIDE, board.getCastlingRightBoth().castlingRightBlack());
  ...
  void testWhiteQueenSideRookMoved() {
    ...
    assertEquals(CastlingRight.KING_SIDE, board.getCastlingRightBoth().castlingRightWhite());
  ...
  void testBlackQueenSideRookMoved() {
    ...
    assertEquals(CastlingRight.KING_SIDE, board.getCastlingRightBoth().castlingRightBlack());
  ...
  void testFenImportAllRights() {
    ...
    assertEquals(CastlingRight.KING_AND_QUEEN_SIDE, board.getCastlingRightBoth().castlingRightWhite());
    assertEquals(CastlingRight.KING_AND_QUEEN_SIDE, board.getCastlingRightBoth().castlingRightBlack());
    assertEquals(CastlingRightLoss.NONE, board.getWhiteKingSideLoss());
    assertEquals(CastlingRightLoss.NONE, board.getWhiteQueenSideLoss());
    assertEquals(CastlingRightLoss.NONE, board.getBlackKingSideLoss());
    assertEquals(CastlingRightLoss.NONE, board.getBlackQueenSideLoss());
