...
class TestSanValidateRnbqNeitherPseudoLegal {
  ...
  void testWhiteNotReachableSingle() {
    ...
    checkException("Be3", board, SanValidationProblem.RNBQ_NEITHER_NOT_REACHABLE_SINGLE);
  }
  ...
  void testBlackNotReachableSingle() {
    ...
    checkException("Be6", board, SanValidationProblem.RNBQ_NEITHER_NOT_REACHABLE_SINGLE);
  }
  ...
  void testWhiteNotReachableMultiple() {
    ...
    checkException("Ne5", board, SanValidationProblem.RNBQ_NEITHER_NOT_REACHABLE_MULTIPLE);
  }
  ...
  void testBlackNotReachableMultiple() {
    ...
    checkException("Ne4", board, SanValidationProblem.RNBQ_NEITHER_NOT_REACHABLE_MULTIPLE);
  }
  ...
  void testWhiteKingInCheckSingle() {
    ...
    checkException("Bd5", board, SanValidationProblem.RNBQ_NEITHER_KING_EXPOSED_TO_CHECK_SINGLE);
  }
  ...
  void testBlackKingInCheckSingle() {
    ...
    checkException("Bd4", board, SanValidationProblem.RNBQ_NEITHER_KING_EXPOSED_TO_CHECK_SINGLE);
  }
  ...
  void testWhiteKingInCheckMultiple() {
    ...
    checkException("Ne4", board, SanValidationProblem.RNBQ_NEITHER_KING_EXPOSED_TO_CHECK_MULTIPLE);
  }
  ...
  void testBlackKingInCheckMultiple() {
    ...
    checkException("Ne5", board, SanValidationProblem.RNBQ_NEITHER_KING_EXPOSED_TO_CHECK_MULTIPLE);
  }
  ...
  void testWhiteKingLeftInCheckSingle() {
    ...
    checkException("Bd5", board, SanValidationProblem.RNBQ_NEITHER_KING_LEFT_IN_CHECK_SINGLE);
  }
  ...
  void testBlackKingLeftInCheckSingle() {
    ...
    checkException("Bd4", board, SanValidationProblem.RNBQ_NEITHER_KING_LEFT_IN_CHECK_SINGLE);
  }
  ...
  void testWhiteKingLeftInCheckMultiple() {
    ...
    checkException("Rd5", board, SanValidationProblem.RNBQ_NEITHER_KING_LEFT_IN_CHECK_MULTIPLE);
  }
