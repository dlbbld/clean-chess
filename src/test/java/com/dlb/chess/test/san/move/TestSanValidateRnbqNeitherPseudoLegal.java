...
class TestSanValidateRnbqNeitherPseudoLegal {
  ...
  void testWhiteNotReachableSingle() {
    ...
    final Board board = new Board("k7/8/8/8/PPPPPPPP/8/1N1N4/2B1K3 w - - 0 1", false);
  ...
  void testBlackNotReachableSingle() {
    ...
    final Board board = new Board("2b1k3/1n1n4/8/pppppppp/8/8/8/4K3 b - - 0 1", false);
  ...
  void testWhiteNotReachableMultiple() {
    ...
    final Board board = new Board("k7/8/8/8/PPPPPPPP/8/8/1N2K1N1 w - - 0 1", false);
  ...
  void testBlackNotReachableMultiple() {
    ...
    final Board board = new Board("1n2k1n1/8/8/pppppppp/8/8/8/4K3 b - - 0 1", false);
  ...
  void testWhiteKingInCheckMultiple() {
    ...
    final Board board = new Board("k7/8/8/8/1b6/6b1/3N1N2/4K3 w - - 0 1", false);
  ...
  void testBlackKingInCheckMultiple() {
    ...
    final Board board = new Board("4k3/3n1n2/6B1/1B6/8/8/8/K7 b - - 0 1", false);
  ...
  void testWhiteKingLeftInCheckMultiple() {
    ...
    final Board board = new Board("r6k/8/3R4/8/8/3R4/8/K7 w - - 0 1", false);
  ...
  void testBlackKingLeftInCheckMultiple() {
    ...
    // but neither resolves check on a-file.
    final Board board = new Board("k7/8/3r4/8/8/3r4/8/R6K b - - 0 1", false);
    checkException("Rd5", board, SanValidationProblem.KING_LEFT_IN_CHECK_RNBQ_NEITHER_MULTIPLE);
  }
