...
class TestSanValidatePawnExists {
  ...
  void testWhite() {

    {
      ...
      checkException("fxg8", board, SanValidationProblem.FORMAT_PAWN_PROMOTION_NO_PROMOTION_SYMBOL);
    }
  ...
  void testBlack() {

    {
      ...
      checkException("bxa1", board, SanValidationProblem.FORMAT_PAWN_PROMOTION_NO_PROMOTION_SYMBOL);
