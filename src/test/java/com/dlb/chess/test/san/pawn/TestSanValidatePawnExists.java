...
class TestSanValidatePawnExists {
  ...
  void testWhite() {

    {
      ...
      checkException("c2", board, SanValidationProblem.MOVEMENT_PAWN_NON_REACHABLE_RANK);
      ...
      checkException("fxg2", board, SanValidationProblem.MOVEMENT_PAWN_NON_REACHABLE_RANK);
  ...
  void testBlack() {

    {
      ...
      checkException("h7", board, SanValidationProblem.MOVEMENT_PAWN_NON_REACHABLE_RANK);
      ...
      checkException("bxa7", board, SanValidationProblem.MOVEMENT_PAWN_NON_REACHABLE_RANK);
