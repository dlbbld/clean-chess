...
class TestSanValidateRnbqFilePseudoLegal {
  ...
  void testWhiteNotReachableSingle() {
    ...
    checkException("Bcb3", board, SanValidationProblem.RNBQ_FILE_NOT_REACHABLE_SINGLE);
  }
  ...
  void testBlackNotReachableSingle() {
    ...
    checkException("Bcb6", board, SanValidationProblem.RNBQ_FILE_NOT_REACHABLE_SINGLE);
  }
  ...
  void testWhiteNotReachableMultiple() {
    ...
    checkException("Raa6", board, SanValidationProblem.RNBQ_FILE_NOT_REACHABLE_MULTIPLE);
  }
  ...
  void testBlackNotReachableMultiple() {
    ...
    checkException("Raa3", board, SanValidationProblem.RNBQ_FILE_NOT_REACHABLE_MULTIPLE);
  }
  ...
  void testWhiteKingInCheckSingle() {
    ...
    checkException("Bed5", board, SanValidationProblem.RNBQ_FILE_KING_EXPOSED_TO_CHECK_SINGLE);
  }
  ...
  void testBlackKingInCheckSingle() {
    ...
    checkException("Bed4", board, SanValidationProblem.RNBQ_FILE_KING_EXPOSED_TO_CHECK_SINGLE);
  }
  ...
  void testWhiteKingInCheckMultiple() {
    ...
    checkException("Bde3", board, SanValidationProblem.RNBQ_FILE_KING_EXPOSED_TO_CHECK_MULTIPLE);
  }
  ...
  void testBlackKingInCheckMultiple() {
    ...
    checkException("Bde6", board, SanValidationProblem.RNBQ_FILE_KING_EXPOSED_TO_CHECK_MULTIPLE);
  }
  ...
  void testWhiteKingLeftInCheckSingle() {
    ...
    checkException("Bcd5", board, SanValidationProblem.RNBQ_FILE_KING_LEFT_IN_CHECK_SINGLE);
  }
  ...
  void testBlackKingLeftInCheckSingle() {
    ...
    checkException("Bcd4", board, SanValidationProblem.RNBQ_FILE_KING_LEFT_IN_CHECK_SINGLE);
  }
