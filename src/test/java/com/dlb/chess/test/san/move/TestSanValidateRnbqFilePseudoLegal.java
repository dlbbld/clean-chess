...
class TestSanValidateRnbqFilePseudoLegal {
  ...
  void testWhiteNotReachableMultiple() {
    ...
    final Board board = new Board("7k/8/8/8/P7/R7/P7/R3K3 w - - 0 1", false);
  ...
  void testBlackNotReachableMultiple() {
    ...
    final Board board = new Board("r3k3/p7/8/r7/P7/8/8/4K3 b - - 0 1", false);
  ...
  void testWhiteKingInCheckMultiple() {
    ...
    final Board board = new Board("k7/7p/8/4b3/3B4/2K5/3B4/4b3 w - - 0 1", false);
  ...
  void testBlackKingInCheckMultiple() {
    ...
    final Board board = new Board("4B3/3b4/2k5/3b4/4B3/8/7P/K7 b - - 0 1", false);
