...
class TestSanValidateRnbqRankPseudoLegal {
  ...
  void testWhiteNotReachableSingle() {
    ...
    checkException("R1a4", board, SanValidationProblem.RNBQ_RANK_NOT_REACHABLE_SINGLE);
  }
  ...
  void testBlackNotReachableSingle() {
    ...
    checkException("R8a5", board, SanValidationProblem.RNBQ_RANK_NOT_REACHABLE_SINGLE);
  }
  ...
  void testWhiteNotReachableMultiple() {
    ...
    checkException("R1a4", board, SanValidationProblem.RNBQ_RANK_NOT_REACHABLE_MULTIPLE);
  }
  ...
  void testBlackNotReachableMultiple() {
    ...
    checkException("R8a5", board, SanValidationProblem.RNBQ_RANK_NOT_REACHABLE_MULTIPLE);
  }
  ...
  void testWhiteKingInCheckSingle() {
    ...
    checkException("B4d5", board, SanValidationProblem.RNBQ_RANK_KING_EXPOSED_TO_CHECK_SINGLE);
  }
  ...
  void testBlackKingInCheckSingle() {
    ...
    checkException("B5d4", board, SanValidationProblem.RNBQ_RANK_KING_EXPOSED_TO_CHECK_SINGLE);
  }
  ...
  void testWhiteKingInCheckMultiple() {
    ...
    checkException("B4c5", board, SanValidationProblem.RNBQ_RANK_KING_EXPOSED_TO_CHECK_MULTIPLE);
  }
  ...
  void testBlackKingInCheckMultiple() {
    ...
    checkException("B5c4", board, SanValidationProblem.RNBQ_RANK_KING_EXPOSED_TO_CHECK_MULTIPLE);
  }
  ...
  void testWhiteKingLeftInCheckSingle() {
    ...
    checkException("B4d5", board, SanValidationProblem.RNBQ_RANK_KING_LEFT_IN_CHECK_SINGLE);
  }
  ...
  void testBlackKingLeftInCheckSingle() {
    ...
    checkException("B5d4", board, SanValidationProblem.RNBQ_RANK_KING_LEFT_IN_CHECK_SINGLE);
  }
