...
/**
 * A single fixture row in the test corpus. The {@link #fen()} string is the cached final position of the PGN file
 * named by {@link #pgnFileName()}; populated when the fixture is added to {@code CreatePgnTestCases}.
 *
 * <p>Two ways to materialise a board from a fixture, chosen by the test author:
 *
 * <ul>
...
public record PgnFileTestCase(String pgnFileName, String expectedRepetition, String expectedNoProgressMoveRule,
    ...
    UnwinnabilityQuickVerdict unwinnableQuickWhite, UnwinnabilityQuickVerdict unwinnableQuickBlack, String fen) {
