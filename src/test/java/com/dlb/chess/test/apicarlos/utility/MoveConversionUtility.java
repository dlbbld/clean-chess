      ...
      switch (moveSpecification.havingMove()) {
        case BLACK:
          return switch (moveSpecification.castlingMove()) {
            case KING_SIDE -> new Move(com.github.bhlangonijr.chesslib.Square.E8, com.github.bhlangonijr.chesslib.Square.G8);
            case QUEEN_SIDE -> new Move(com.github.bhlangonijr.chesslib.Square.E8, com.github.bhlangonijr.chesslib.Square.C8);
            case NONE -> throw new IllegalArgumentException();
            default -> throw new IllegalArgumentException();
          };
        case WHITE:
          return switch (moveSpecification.castlingMove()) {
            case KING_SIDE -> new Move(com.github.bhlangonijr.chesslib.Square.E1, com.github.bhlangonijr.chesslib.Square.G1);
            case QUEEN_SIDE -> new Move(com.github.bhlangonijr.chesslib.Square.E1, com.github.bhlangonijr.chesslib.Square.C1);
            case NONE -> throw new IllegalArgumentException();
            default -> throw new IllegalArgumentException();
          };
        case NONE:
