package com.dlb.chess.test.pgn.reader.linebreaks;
...
public class TestPgnReaderLineBreaks {

  private static final Logger logger = NonNullWrapperCommon.getLogger(TestPgnReaderLineBreaks.class);
