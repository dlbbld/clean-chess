...
public class TestLenientPgnParserUtf8 {
  ...
  private static final Logger logger = NonNullWrapperCommon.getLogger(TestLenientPgnParserUtf8.class);
  ...
  private static void check(String pgn, String fileName) {
    ...
    final Path filePath = NonNullWrapperCommon.resolve(PgnTestConstants.LENIENT_PGN_PARSER_UTF8_TEST_ROOT_FOLDER_PATH,
        fileName);
