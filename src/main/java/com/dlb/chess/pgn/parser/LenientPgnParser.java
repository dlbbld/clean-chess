...
public class LenientPgnParser extends AbstractPgnParser {
  ...
  public static PgnFile parse(List<String> fileLines) {
    final List<Tag> tagList = LenientParseTagUtility.validateTagList(fileLines);
  ...
  public static LenientPgnParserValidationResult validate(List<String> fileLines) {
    try {
      parse(fileLines);
