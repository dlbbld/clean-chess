...
public class PawnAnyAdvanceEmptyBoardSquares extends AbstractEmptyBoardSquares implements EnumConstants {
  ...
  static {
    final EnumMap<Square, ImmutableSet<Square>> pawnWhiteMap = Maps.newEnumMap(Square.class);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(A3, A4);
      pawnWhiteMap.put(A2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(B3, B4);
      pawnWhiteMap.put(B2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(C3, C4);
      pawnWhiteMap.put(C2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(D3, D4);
      pawnWhiteMap.put(D2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(E3, E4);
      pawnWhiteMap.put(E2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(F3, F4);
      pawnWhiteMap.put(F2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(G3, G4);
      pawnWhiteMap.put(G2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(H3, H4);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(A6);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(C6);
      pawnWhiteMap.put(C5, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(D6);
      pawnWhiteMap.put(D5, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(E6);
      pawnWhiteMap.put(E5, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(F6);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(H6);
      pawnWhiteMap.put(H5, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(A7);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(C7);
      pawnWhiteMap.put(C6, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(D7);
      pawnWhiteMap.put(D6, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(E7);
      pawnWhiteMap.put(E6, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(F7);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(H7);
      pawnWhiteMap.put(H6, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(A8);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(C8);
      pawnWhiteMap.put(C7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(D8);
      pawnWhiteMap.put(D7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(E8);
      pawnWhiteMap.put(E7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(F8);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(H8);
    ...
    PAWN_WHITE_SQUARES = NonNullWrapperCommon.immutableEnumMap(pawnWhiteMap);

    ValidateMoveNumberUtility.validateMapOfSet(PAWN_WHITE_SQUARES, 56);
  ...
  static {
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(A1);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(C1);
      pawnBlackMap.put(C2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(D1);
      pawnBlackMap.put(D2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(E1);
      pawnBlackMap.put(E2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(F1);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(H1);
      pawnBlackMap.put(H2, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(A2);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(C2);
      pawnBlackMap.put(C3, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(D2);
      pawnBlackMap.put(D3, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(E2);
      pawnBlackMap.put(E3, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(F2);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(H2);
      pawnBlackMap.put(H3, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(A3);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(C3);
      pawnBlackMap.put(C4, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(D3);
      pawnBlackMap.put(D4, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(E3);
      pawnBlackMap.put(E4, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(F3);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(H3);
    ...
    {
      final ImmutableSet<Square> squareSet = constructSet(A5, A6);
      pawnBlackMap.put(A7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(B5, B6);
      pawnBlackMap.put(B7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(C5, C6);
      pawnBlackMap.put(C7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(D5, D6);
      pawnBlackMap.put(D7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(E5, E6);
      pawnBlackMap.put(E7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(F5, F6);
      pawnBlackMap.put(F7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(G5, G6);
      pawnBlackMap.put(G7, squareSet);
    }

    {
      final ImmutableSet<Square> squareSet = constructSet(H5, H6);
    ...
    ValidateMoveNumberUtility.validateMapOfSet(PAWN_BLACK_SQUARES, 56);
