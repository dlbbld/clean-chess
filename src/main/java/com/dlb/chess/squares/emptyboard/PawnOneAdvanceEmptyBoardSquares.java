...
public class PawnOneAdvanceEmptyBoardSquares extends AbstractEmptyBoardSquares implements EnumConstants {
  ...
  static {
    ...
    ValidateMoveNumberUtility.validateMapOfSet(PAWN_WHITE_SQUARES, 48);
  ...
  static {
    ...
    ValidateMoveNumberUtility.validateMapOfSet(PAWN_BLACK_SQUARES, 48);
