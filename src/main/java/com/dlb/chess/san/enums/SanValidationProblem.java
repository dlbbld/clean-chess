...
public enum SanValidationProblem {
  ...
  CAPTURING_MOVING_ONTO_NO_PIECE(true),
  ...
  PIECE_RANK_NO_PIECE_EXISTS(true),
  ...
  PIECE_SQUARE_NO_PIECE_EXISTS(true),
  PIECE_SQUARE_MOVING_ONTO_ITSELF(true),
  PIECE_SQUARE_NO_LEGAL_MOVE(true),
  PIECE_SQUARE_ONLY_ONE_LEGAL_MOVE(true),
  PIECE_SQUARE_FILE_NOT_NECESSARY(true),
  PIECE_SQUARE_RANK_NOT_NECESSARY(true),
  PIECE_SQUARE_MUST_USE_FILE_OR_SQUARE(true);
