 ...
 *
 * <p>Legal moves are sorted by from-square, then to-square, then castling move, then promotion
 * choice. For the promotion component the order is by descending practical piece value: queen
 * first, then rook, bishop, knight, and finally the {@link PromotionPieceType#NONE} placeholder.
 * This is the natural way to think about a promotion choice (strongest outcome first) and is
 * deliberately independent of the enum declaration order in {@link PromotionPieceType}, which
...
public final class PromotionPieceTypeUtility {
  ...
  /**
   * Compares two promotion piece types using the legal-move ordering rule: queen, rook, bishop,
   * knight, none.
   *
   ...
   *         equal to, or greater than the second under the move-ordering rule
   */
