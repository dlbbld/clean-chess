...
public class UnwinnableFull {
  ...
  public static UnwinnableFullResult unwinnableFull(ApiBoard board, Side c) {
    ...
    if (UnwinnableSemiStatic.unwinnableSemiStatic(board, c, mobilitySolution)) {
      return UnwinnableFullResult.UNWINNABLE;
    }
    ...
    for (var maxDepth = 0; maxDepth <= Integer.MAX_VALUE; maxDepth++) {
      ...
      switch (bd) {
        case TRUE:
          ...
          return UnwinnableFullResult.WINNABLE;
        case FALSE:
